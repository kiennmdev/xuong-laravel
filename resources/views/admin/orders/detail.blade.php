                        ...
                        <table class="table table-nowrap align-middle table-borderless mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 avatar-md bg-light rounded p-1">
                                                <img src="{{Storage::url($item->product_img_thumbnail)}}" alt="" class="img-fluid d-block">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-15"><a href="apps-ecommerce-product-details.html" class="link-primary">{{$item->product_name}} ({{$item->variant_color_name}})</a></h5>
                                    ...
                                    <td>
                                        <del class="text-body-secondary">{{$item->product_price_regular}}<sup>đ</sup></del>
                                    </td>
                                    <td>
                                        {{$item->product_price_sale}}<sup>đ</sup>
                                    </td>
                                    <td>{{$item->quantity}}</td>
                                    <td class="fw-medium text-end">
                                        {{$item->product_price_sale*$item->quantity}}<sup>đ</sup>
                                    </td>
                                </tr>
                                        ...
                                        <table class="table table-borderless mb-0">
                                            <tbody>
                                                ...
                                                <tr class="border-top border-top-dashed">
                                                    ...
                                                    <th class="text-end">{{$order->total_price}}<sup>đ</sup></th>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </td>
